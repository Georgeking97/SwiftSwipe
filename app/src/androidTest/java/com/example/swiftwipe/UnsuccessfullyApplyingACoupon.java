...
public class UnsuccessfullyApplyingACoupon {

    /*
    This test works by adding an item to the cart and trying to apply a coupon. If the amount is the same
    after trying to apply a failed coupon the functionality is working as intended.
     */
    ...
    @Test
    public void unsuccessfullyApplyingACoupon() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.totalAmountTxt), withText("€15.99"),
                        withParent(allOf(withId(R.id.cartInfo),
                                withParent(IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class)))),
                        isDisplayed()));
        textView2.check(matches(withText("€15.99")));
    }
