...
public class OrdersViewPageLayoutTest {

    @Rule
    public ActivityTestRule<Login> mActivityTestRule = new ActivityTestRule<>(Login.class);

    @Test
    public void ordersViewPageLayoutTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.orderName), withText("Apr 21, 2021 6:18:36 PM"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))),
                        isDisplayed()));
        textView.check(matches(withText("Apr 21, 2021 6:18:36 PM")));
    }
